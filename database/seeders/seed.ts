...
export default class DatabaseSeeder extends BaseSeeder {
  public async run() {
    ...
    await RolePermission.createMany([
      ...
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events')?.id },
      ...
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-tickets')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-coupons')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-collaborators')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-guestlist')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-checkin')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'view-events-orders-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-tickets')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-coupons')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-collaborators')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-guestlist')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'add-events-orders-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'do-events-checkin')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'undo-events-checkin')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'resend-events-tickets-from-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'print-events-tickets-from-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'cancel-events-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-tickets')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-coupons')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-collaborators')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-guestlist')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'edit-events-orders-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-tickets')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-coupons')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-collaborators')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-guestlist')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-orders')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'delete-events-orders-pdv')?.id },
      { id: uuidv4(), role_id: roles.find(role => role.name === 'Cliente')?.id, permission_id: permissions.find(permission => permission.name === 'export-events')?.id },
    ]);
