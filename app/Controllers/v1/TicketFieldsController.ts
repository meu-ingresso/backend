...
export default class TicketFieldsController {
  ...
  public async create(context: HttpContextContract) {
    ...
    await utils.createAudity('CREATE', 'TICKET_FIELD', result.id, context.auth.user?.$attributes.id, null, result);
  ...
  public async search(context: HttpContextContract) {
    ...
    const result = await this.dynamicService.search('TicketField', payload);
